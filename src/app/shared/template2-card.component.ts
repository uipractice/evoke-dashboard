        ...
        <button (click)="openPdfInNewTab(card.pdfLink)">
          <div class="flex flex-col sm:flex-row items-center bg-white shadow-lg rounded-lg overflow-hidden h-auto sm:h-[132px]">
            ...
            <div class="w-full sm:w-2/3 px-6 py-4">
              ...
              <p class="text-14 sm:text-base text-gray-700 line-clamp-2 text-left">{{card.description}}</p>
            </div>
          </div>
        </button>
      }
        ...
        <button (click)="openPdfInNewTab(card.pdfLink)">
          <div class="flex flex-col sm:flex-row items-center bg-white shadow-lg rounded-lg overflow-hidden h-auto sm:h-[132px]">
            ...
            <div class="w-full sm:w-2/3 p-3 py-6 px-4">
              <h1 class="text-lg sm:text-xl font-medium text-gray-900 mb-2 text-left border-b border-solid pb-2">{{card.cardTitle}}</h1>
              <p class="text-14 sm:text-base text-gray-700 line-clamp-3 text-left">{{card.description}}</p>
            </div>
          </div>
        </button>
      }
